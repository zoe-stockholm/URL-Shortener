"""
Django settings for Dev_Fyndiq project.
...
SECRET_KEY = '1ygj4z$25geat1v^_tua^0%viu4f7ju2va=9in*ynry-q05e+g'
...
ROOT_URLCONF = 'Dev_Fyndiq.urls'

WSGI_APPLICATION = 'Dev_Fyndiq.wsgi.application'
...
if 'test' in sys.argv or 'test_coverage' in sys.argv:
    print "test database loaded in local"
    TESTING_MODE = True
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3',
